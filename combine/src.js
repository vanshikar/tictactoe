...
function startGame()
{
    ...
    //reactivate board buttons
    for(var i = 0;i<n*n;i++)
    {
        document.getElementById("cell"+n+"-"+i).style.cursor = 'pointer';
    }
...
function clearBoard()
{
    ...
    document.getElementById("depth"+1).onclick = function() {setDifficulty(1)};
    document.getElementById("depth"+2).onclick = function() {setDifficulty(2)};
    document.getElementById("depth"+3).onclick = function() {setDifficulty(3)};
    document.getElementById("depth"+4).onclick = function() {setDifficulty(4)};
    document.getElementById("depth"+-1).onclick = function() {setDifficulty(-1)};
    //board size
    ...
    document.getElementById("s3").onclick = function() {setBoardSize(3)};
    document.getElementById("s4").onclick = function() {setBoardSize(4)};
    document.getElementById("s5").onclick = function() {setBoardSize(5)};
    document.getElementById("s6").onclick = function() {setBoardSize(5)};
    //remove winning line
    if(winn) 
    {
    ...
    if(n==3)
    {
        ...
        for(var i = 0;i<9;i++)
        {
            document.getElementById("cell3-"+i).style.cursor='not-allowed';
        }
    }
    ...
    if(n==4)
    {
        ...
        for(var i = 0;i<16;i++)
        {
            document.getElementById("cell4-"+i).style.cursor='not-allowed';
        }
    }
    ...
    if(n==5)
    {
        ...
        for(var i = 0;i<25;i++)
        {
            document.getElementById("cell5-"+i).style.cursor='not-allowed';
        }
    }
    ...
    if(n==6)
    {
        ...
        for(var i = 0;i<36;i++)
        {
            document.getElementById("cell6-"+i).style.cursor='not-allowed';
        }
    }
