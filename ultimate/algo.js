...
function startGame()
{
    ...
    document.getElementById("depth1").style.cursor = 'not-allowed';
    document.getElementById("depth1").onclick = null;
    document.getElementById("depth3").style.cursor = 'not-allowed';
    document.getElementById("depth3").onclick = null;
    document.getElementById("depth4").style.cursor = 'not-allowed';
    document.getElementById("depth4").onclick = null;
    document.getElementById("depth5").style.cursor = 'not-allowed';
    document.getElementById("depth5").onclick = null;
    document.getElementById("depth8").style.cursor = 'not-allowed';
    document.getElementById("depth8").onclick = null;
...
function newGame()
{
    ...
    //depth
    document.getElementById('depth1').style.cursor = 'pointer';
    document.getElementById('depth3').style.cursor = 'pointer';
    document.getElementById('depth4').style.cursor = 'pointer';
    document.getElementById('depth5').style.cursor = 'pointer';
    document.getElementById('depth8').style.cursor = 'pointer';
    
    document.getElementById('depth1').onclick = function() {setDifficulty(1)};
    document.getElementById('depth3').onclick = function() {setDifficulty(3)};
    document.getElementById('depth4').onclick = function() {setDifficulty(4)};
    document.getElementById('depth5').onclick = function() {setDifficulty(5)};
    document.getElementById('depth8').onclick = function() {setDifficulty(8)};
    //remove winning line
    if(winn)
    {
        document.getElementById("board").classList.remove(winn);
...
{
    document.getElementById('depth'+difficulty).classList.remove('active');
